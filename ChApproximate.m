function [TheoChannel_Ac,TheoChannel_FF,TheoChannel_FF_ap]=ChApproximate(par,temp_UETX_dis,termConstant,flagLoS,flagNLoS)
% This function computes the approximation of the channel capacity of MISO
UETX_dis=par.UETX.distance;
constant=par.wavenumber*UETX_dis;
temp_direc_x= -temp_UETX_dis.X./UETX_dis;
...
TheoChannel_Ac=Exp_MISO_Ac.*conj(Exp_MISO_Ac)+Var_MISO_Ac;
...
TheoChannel_FF=Exp_MISO_FF.*conj(Exp_MISO_FF)+Var_MISO_FF; 
...
TheoChannel_FF_ap=length(UETX_dis)*Exp_MISO_FF_ap; 
