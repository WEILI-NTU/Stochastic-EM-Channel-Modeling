function  [IncoGreenExp,IncoGreenVar]=IncoGreenFuncIndi(par,tra,rec,cavity_ki)
% This function generates the incoherent part, i.e., stochastic Green's
% Function
 
%% Generate the \overline{\overline{\mathbf{D}}}
term_kR=cavity_ki.*par.UETX.distance; 
term_2kR=2*term_kR; 
...
IncoGreenExp.XY=zeros(rec.totalNum,tra.totalNum);
IncoGreenExp.XZ=zeros(rec.totalNum,tra.totalNum);
IncoGreenExp.YZ=zeros(rec.totalNum,tra.totalNum);
